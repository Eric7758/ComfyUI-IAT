...
| 🧠 **Qwen3.5 Dataset RAG Reverse Prompt** | Dataset-Aware Reverse Prompt | Generate prompts from images in the style of a selected local dataset knowledge base |
...
| 🧠 **Qwen3.5 数据集RAG反推提示词** | 数据集风格反推 | 按所选本地数据集知识库的标注风格从图像生成提示词 |
